...
import os
import pandas as pd
from project_files.morphomnist.data import io
...
def normalize(data, load=False, save=True, path='./project_files/morphomnist/data/norm_params.pt'):
    # Normalize images
    if load:
...
class MorphoMNISTLike(Dataset):
    def __init__(self, data_dir='./project_files/morphomnist/data', train=True, columns=None, normalize_=True, transform=None):
