...
from project_files.morphomnist.baselines.wrong_graph.model import WGMmnistSCM
...
def main(data_dir, weights={"thickness" : 1., "intensity" : 1., "image" : 1.}, idx=5, wrong_graph=False, sparse=False, custom_dist=False):
    ...
    plt.show()
    #tikzplotlib.save("./project_files/morphomnist/visualizations/tex_files/visualize_tast_to_iast_custom_loss.tex")

if __name__ == "__main__":
    main("./project_files/morphomnist/data", weights={"thickness" : 1.15, "intensity" : 1., "image" : 1.}, 
