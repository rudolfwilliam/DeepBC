...
def main(data_dir, weights={"thickness" : 1., "intensity" : 1., "image" : 1.}, idx=5, wrong_graph=False, sparse=False, custom_dist=False):
    ...
    plt.show()
    #tikzplotlib.save("./project_files/morphomnist/visualizations/visualize_iast_to_tast_wg_sparse.tex")

if __name__ == "__main__":
    main("./project_files/morphomnist/data", idx=5, weights={"thickness" : 1.8, "intensity" : 1., "image" : 1.}, 
