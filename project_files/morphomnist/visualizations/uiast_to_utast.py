...
from project_files.morphomnist.scm import MmnistSCM
...
def main(data_dir, idx=5):
    ...
    #tikzplotlib.save("./project_files/morphomnist/visualizations/visualize_uiast_to_utast.tex", extra_axis_parameters=['axis equal image'])
    plt.show()
