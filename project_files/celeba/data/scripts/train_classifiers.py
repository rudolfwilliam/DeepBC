...
from project_files.celeba.data.meta_data import attrs, attr2int
...
def main(ckpt_path="./project_files/celeba/scm/trained_models/config/", default_root_dir="./project_files/celeba/scm"):
