...
def main(normalize=True, batch_size=64, ckpt_path="./project_files/celeba/data/trained_models/classifiers/checkpoints/"):
    # load data
    data = load_data()
    ...
    if normalize:
        ...
        torch.save(means, "./project_files/celeba/data/predictions/means.pt")
        torch.save(stds, "./project_files/celeba/data/predictions/stds.pt")
