...
import torch
from project_files.celeba.data.meta_data import attrs, vars2int, attr2int

DATA_PATH = "./project_files/celeba/data"
MEANS_PATH = "./project_files/celeba/data/predictions/means.pt"
STDS_PATH = "./project_files/celeba/data/predictions/stds.pt"
...
class CelebaContinuous(Dataset):
    def __init__(self, cont_attr_path="./project_files/celeba/data/predictions/preds.pt", transform=None, as_dict=False):
        super().__init__()
        self.transform = transform
        self.as_dict = as_dict
        self.data = load_data()
