...
import torch
#import tikzplotlib
from project_files.celeba.scm import CelebaSCM
from project_files.celeba.data.meta_data import graph_structure
...
def main():
    ...
    plt.ylabel(y)
    plt.show()
    #tikzplotlib.save("./project_files/celeba/visualizations/tex_files/visualize_compare_cfs_intensity.tex")
