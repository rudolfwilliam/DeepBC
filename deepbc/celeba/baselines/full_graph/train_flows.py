...
def main():
    ...
    config["ckpt_path"] = "./celeba/baselines/full_graph/trained_models/checkpoints/"
    # initialize models
    ...
    for flow in flows:
        train_flow(flow=flow, config=config, data_class=CelebaContinuous, graph_structure=wrong_graph_structure, attrs=attrs,
                   cont_attr_path="./celeba/data/predictions/preds.pt", default_root_dir="./celeba/baselines/full_graph")
    print("done.")
