...
def main(data_dir, weights={"thickness" : 1., "intensity" : 1., "image" : 1.}, idx=5, wrong_graph=False):
    if wrong_graph:
        scm = WGMmnistSCM()
    else:
        scm = MmnistSCM()
    ...
    plt.scatter(xs_ast['intensity'], xs_ast['thickness'], c=list(plt.rcParams['axes.prop_cycle'])[3]['color'], s=10)
...
if __name__ == "__main__":
    main("./morphomnist/data", weights={"thickness" : 1., "intensity" : 1., "image" : 1.}, idx=5, wrong_graph=True)
