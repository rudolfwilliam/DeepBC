...
def backtrack_linearize(scm, vars_, vals_ast, lambda_=5000, num_it=30, sparse=False, n_largest=2, const_idxs=None, **us):
    """Backtracking with constraint linearization (generally recommended). Can be done in a batched fashion."""
    us_pr = initialize_us_pr(**us)
...
def sparsify(scm, vars_, vals_ast, us_pr_flat, lambda_=10000, num_it=30, n_largest=2, **us):
